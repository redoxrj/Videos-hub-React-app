...
const Videos = () => {
  ...
  return (
    <Stack direction={['column','row']} h={'100vh'}>
        <VStack w={'full'}>
            <video  loop  autoplay controls controlsList='nodownload' style={{width:'100%'}} src={videoSrc}></video>
         <img src="" alt="" />

            <VStack alignItems={'flex-start'} w={'full'} p={['2','4']} overflow={'auto'}>
                <Heading>Sample Video </Heading>
                <Text>This is a Sample video for testing purpose, This is called description for our Videoshub.</Text>
            </VStack>

        </VStack>
        <VStack w={['full','xl']} alignItems={'stretch'} p={'4'} spacing={'5'} overflowY={'auto'}>
            {videosArr && videosArr.map((item,index)=>
